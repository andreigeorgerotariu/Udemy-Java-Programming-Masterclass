...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //This class should contain 2 references t o items which will represent the next and previous
        //items (in the case of LinkedList).
        ...
        //The abstract class will also need to hold value - try to be as flexible as possible
        ...
        //Create a concrete class from your abstract list items class and use this in a LinkedList class
        //to implement a linked list that will add items in order (so that they are sorted alphabetically).
        //Duplicate values are not added.

        //Note that you are creating your own LinkedList class here, not using the built-in Java one...

        //The rules for adding an item to linked list are:
        //  If the head of the list is null, make the head refer to the item to be added.
        //  If the item to be added is less than the current item in the list, add the item before the current
        //item (i.e., make the previous item's "next" refer to the new item, and the new item's "next" refer
        //to the current item).
        ...
        //Care will be needed when inserting before the first time in the list (as it will not have a previous
        //item).
        ...
        //Optional: create a class to use your concrete class to implement Binary search Tree:
        //When adding items to a Binary Search Tree, if the item to be added is less than the current item
        //then move to the left, if it is greater than the current item then m ove to the right.

        //The new item is added when an attempt to move in the required direction would involve following a
        //null reference.
        //Once again, duplicates are not allowed.

        //Hint: to avoid typing loads of "addItem" lines, split a String into an array to create your list in
